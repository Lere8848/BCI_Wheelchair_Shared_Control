...
class FusionNode(Node):
    def __init__(self):
        ...
        self.gt_input_sub = self.create_subscription(Int8, '/gt_input', self.gt_input_callback, 10) # Subscribe to Ground Truth input

        # Subscribe to potential field commands
        self.auto_cmd_sub = self.create_subscription(Twist, '/auto_cmd_vel', self.auto_cmd_callback, 10) 

        # subscribe to path information
